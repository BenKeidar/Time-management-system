...
namespace Win1 {
    ...
    public partial class DiaryDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TasksDataTable : global::System.Data.TypedTableBase<TasksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TasksRow AddTasksRow(int Id, string Title, string Deadline, int IsDone) {
        ...
        public partial class TasksRow : global::System.Data.DataRow {
            ...
            public int IsDone {
                get {
                    try {
                        return ((int)(this[this.tableTasks.IsDoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'IsDone\' in table \'Tasks\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTasks.IsDoneColumn] = value;
                }
            }
            ...
            public bool IsIsDoneNull() {
                return this.IsNull(this.tableTasks.IsDoneColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetIsDoneNull() {
                this[this.tableTasks.IsDoneColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Win1.DiaryDBDataSetTableAdapters {
    ...
    public partial class TasksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Tasks] WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Deadline = 1 AND [Deadline] IS NULL) OR ([Deadline] = @Original_Deadline)) AND ((@IsNull_IsDone = 1 AND [IsDone] IS NULL) OR ([IsDone] = @Original_IsDone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tasks] ([Id], [Title], [Deadline], [IsDone]) VALUES (@Id, @Tit" +
                "le, @Deadline, @IsDone);\r\nSELECT Id, Title, Deadline, IsDone FROM Tasks WHERE (I" +
                "d = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Tasks] SET [Id] = @Id, [Title] = @Title, [Deadline] = @Deadline, [IsDone] = @IsDone WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Deadline = 1 AND [Deadline] IS NULL) OR ([Deadline] = @Original_Deadline)) AND ((@IsNull_IsDone = 1 AND [IsDone] IS NULL) OR ([IsDone] = @Original_IsDone)));
SELECT Id, Title, Deadline, IsDone FROM Tasks WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, Deadline, IsDone FROM dbo.Tasks";
        ...
        public virtual int Fill(DiaryDBDataSet.TasksDataTable dataTable) {
        ...
        public virtual DiaryDBDataSet.TasksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DiaryDBDataSet.TasksDataTable dataTable = new DiaryDBDataSet.TasksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DiaryDBDataSet.TasksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Deadline, global::System.Nullable<int> Original_IsDone) {
            ...
            if ((Original_IsDone.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_IsDone.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string Title, string Deadline, global::System.Nullable<int> IsDone) {
            ...
            if ((IsDone.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(IsDone.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Title, string Deadline, global::System.Nullable<int> IsDone, int Original_Id, string Original_Title, string Original_Deadline, global::System.Nullable<int> Original_IsDone) {
            ...
            if ((IsDone.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(IsDone.Value));
            }
            else {
            ...
            if ((Original_IsDone.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_IsDone.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Deadline, global::System.Nullable<int> IsDone, int Original_Id, string Original_Title, string Original_Deadline, global::System.Nullable<int> Original_IsDone) {
            return this.Update(Original_Id, Title, Deadline, IsDone, Original_Id, Original_Title, Original_Deadline, Original_IsDone);
        }
    }
